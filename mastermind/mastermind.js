...
app.get('/', function(req, res){
    res.sendFile('/home/pi/web/mastermind/mastermind.html');
});

app.use(express.static('/home/pi/web/mastermind'));
...
io.on('connection', function(socket){
    ...
    socket.on('setCombination', function(combination)
    {
    ...
    socket.on('play', function(combination){
...
http.listen(3005, function(){
    console.log('4connect listening on *:3005');
});
